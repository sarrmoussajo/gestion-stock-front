...
const AnnulerSolde = () => {
    ...
    const HandleSubmit = () => {
        try {
            ...
            async function solderPrix() {
                const response = await API.post(`annuler-solder-article`, {
    ...
    useEffect(() => {
        try {
            async function getArticles() {
                const response = await API.post(`articles-boutique-solder`, {
                    boutique_id: user.affectation
                });
            ...
            if (formData.nom_article !== '') {
                ...
                if (article) {
                    setFormData({
                        ...
                        date_fin_solde: article.date_fin_solde,
                        prix: article.prix
                    });
                    setPrix(true);
                }
    ...
    return (
        <>
            <Grid item xs={8}>
                <Item elevation={0}>Annuler Solde d'une article</Item>
            </Grid>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <Button
                                                                ...
                                                                disabled={formData.prix > 0 ? false : true}
                                                            >
                                                                Annuler
                                                            </Button>
                                                        </FormControl>
